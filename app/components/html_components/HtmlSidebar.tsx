            ...
            <div className="mb-3">
              ...
              <div className="space-y-0.5">
                ...
                >
                  ...
                  <span className="text-text-muted">What is HTML?</span>
                </button>
                <button
                ...
                >
                  ...
                  <span className="text-text-muted">Page Structure</span>
                </button>
              </div>
            </div>
                ...
                {lessons.map((lesson) => (
                  ...
                  >
                    ...
                    <div className="flex-1 text-left">
                      ...
                      <div className="text-[10px] text-text-muted font-mono">{lesson.tag}</div>
                    </div>
                  </button>
                ))}
              </div>
