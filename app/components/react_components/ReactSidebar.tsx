          ...
          <div className="p-3 border-b border-gray-100 bg-gradient-to-r from-slate-50 to-white">
            <div className="flex items-center gap-2">
              <div className="p-1.5 bg-sky-100 rounded-lg">
                <FiList className="text-sky-700" size={16} />
              </div>
              <div>
            ...
            <div className="mb-3">
              ...
              <div className="space-y-0.5">
                ...
                >
                  ...
                  <span className="text-slate-600">What is React?</span>
                </button>
                <button
                ...
                >
                  ...
                  <span className="text-slate-600">React Component</span>
                </button>
              </div>
            </div>
            <div>
                ...
                {lessons.map((lesson) => (
                  ...
                  >
                    <span
                      ...
                      style={{
                        backgroundColor:
                          activeSection === lesson.id ? `${lesson.color}` : '#f1f5f9',
                        color: activeSection === lesson.id ? '#000' : '#475569',
                      }}
                    >
                      {lesson.id}
                    </span>
