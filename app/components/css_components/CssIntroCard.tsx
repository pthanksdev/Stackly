...
export default function CssIntroCard({
  ...
  return (
    <motion.div
      ...
      id="css-intro"
      className="bg-gradient-to-br from-blue-700 to-blue-600 dark:from-blue-900 dark:to-black rounded-2xl overflow-hidden shadow-xl transition-all duration-500"
    >
